...
/*** Mimic new data/changes to test script ***/
USE DATABASE MY_LAB

---- Update FACT raw tables
INSERT INTO LND_WALMART.SALES
VALUES
...
INSERT INTO LND_WALMART.INVENTORY
VALUES
...
UPDATE LND_WALMART.PRODUCT SET PROD_NAME='CHANGE-1' WHERE PROD_KEY=657768;
UPDATE LND_WALMART.PRODUCT SET PROD_NAME='CHANGE-2' WHERE PROD_KEY=293693;
INSERT INTO LND_WALMART.PRODUCT VALUES (999999,'ADD-1',2.22, 88.88, 'brand-999', 1, 'active', 4, 'category-4', 1, 'subcategory-1');

--- check
SELECT min(cal_Dt), MAX(cal_dt) FROM ANL_WALMART.sales_inv_store_dy;
SELECT * FROM ANL_WALMART.product_dim WHERE PROD_KEY=657768;