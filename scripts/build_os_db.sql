...
CREATE SCHEMA IF NOT EXISTS LND_WALMART;

----STORE
CREATE OR REPLACE TABLE LND_WALMART.store
(
	store_key integer,
...
----CALENDAR
CREATE OR REPLACE TABLE LND_WALMART.calendar
(	
...
----PRODUCT
CREATE OR REPLACE TABLE LND_WALMART.product 
(
	prod_key int ,
	prod_name varchar,
	vol numeric (38,2),
...
-----SALES
CREATE OR REPLACE TABLE LND_WALMART.sales(
trans_id int,
prod_key int,
store_key int,
trans_dt date,
...
----INVENTORY
CREATE OR REPLACE TABLE LND_WALMART.inventory (
cal_dt date,
store_key int,
prod_key int,
